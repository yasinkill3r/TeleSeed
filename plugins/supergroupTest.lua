...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'ѕυperɢroυp нαѕ вeeɴ αdded!'
...
local title ="🌐ιɴғo ғor ѕυperɢroυp🌐: ["..result.title.."]\n\n"
local admin_num = "👤αdмιɴ coυɴт👤: "..result.admins_count.."\n"
local user_num = "🔰User coυɴт🔰: "..result.participants_count.."\n"
local kicked_num = "❌ĸιcĸed υѕer coυɴт❌: "..result.kicked_count.."\n"
local channel_id = "🆔 ιd 🆔: "..result.peer_id.."\n"
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == '🔒' then
    return '🔒lιɴĸ poѕтιɴɢ ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_link'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒lιɴĸ poѕтιɴɢ нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  local group_link_lock = data[tostring(target)]['settings']['lock_link']
  if group_link_lock == '🔓' then
    return '🔓lιɴĸ poѕтιɴɢ ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['lock_link'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓lιɴĸ poѕтιɴɢ нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_all(msg, data, target)
  ...
  if group_all_lock == '🔒' then
    return '🔒αll ѕeттιɴɢ ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['all'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒αll ѕeттιɴɢ нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_all(msg, data, target)
  ...
  local group_all_lock = data[tostring(target)]['settings']['all']
  if group_all_lock == '🔓' then
    return '🔓αll ѕeттιɴɢ ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['all'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓αll ѕeттιɴɢ нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_etehad(msg, data, target)
  ...
  if group_etehad_lock == '🔒' then
    return '🔒eтeнαd ѕeттιɴɢ ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['etehad'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒eтeнαd ѕeттιɴɢ нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_etehad(msg, data, target)
  ...
  local group_etehad_lock = data[tostring(target)]['settings']['etehad']
  if group_etehad_lock == '🔓' then
    return '🔓eтeнαd ѕeттιɴɢ ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['etehad'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓eтeнαd ѕeттιɴɢ нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_leave(msg, data, target)
  ...
  if group_leave_lock == '🔒' then
    return '🔒leαve ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['leave'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒leαve нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_leave(msg, data, target)
  ...
  local group_leave_lock = data[tostring(target)]['settings']['leave']
  if group_leave_lock == '🔓' then
    return '🔓leαve ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['leave'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓leαve нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_operator(msg, data, target)
  ...
  if group_operator_lock == '🔒' then
    return '🔒operαтor ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['operator'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒operαтor нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_operator(msg, data, target)
  ...
  local group_operator_lock = data[tostring(target)]['settings']['operator']
  if group_operator_lock == '🔓' then
    return '🔓operαтor ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['operator'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓operαтor нαѕ вeeɴ υɴlocĸed🔓'
  end
end

local function lock_group_web(msg, data, target)
  if not is_momod(msg) then
    return
  end
  local group_web_lock = data[tostring(target)]['settings']['web']
  if group_web_lock == '🔒' then
    return '🔒web ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['web'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒web нαѕ вeeɴ locĸed🔒'
  end
end

local function unlock_group_web(msg, data, target)
  if not is_momod(msg) then
    return
  end
  local group_web_lock = data[tostring(target)]['settings']['web']
  if group_web_lock == '🔓' then
    return 'web ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['web'] = '🔓'
    save_data(_config.moderation.data, data)
    return 'web нαѕ вeeɴ υɴlocĸed🔓'
  end
end

local function lock_group_num(msg, data, target)
  if not is_momod(msg) then
    return
  end
  local group_web_lock = data[tostring(target)]['settings']['num']
  if group_num_lock == '🔒' then
    return '🔒number ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['num'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒number нαѕ вeeɴ locĸed🔒'
  end
end

local function unlock_group_num(msg, data, target)
  if not is_momod(msg) then
    return
  end
  local group_web_lock = data[tostring(target)]['settings']['num']
  if group_web_lock == '🔓' then
    return 'number ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['num'] = '🔓'
    save_data(_config.moderation.data, data)
    return 'number нαѕ вeeɴ υɴlocĸed🔓'
  end
end

local function lock_group_chal(msg, data, target)
  if not is_momod(msg) then
    return
  end
  local group_chal_lock = data[tostring(target)]['settings']['chal']
  if group_chal_lock == '🔒' then
    return '🔒chalesh ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['chal'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒chalesh нαѕ вeeɴ locĸed🔒'
  end
end

local function unlock_group_chal(msg, data, target)
  if not is_momod(msg) then
    return
  end
  local group_chal_lock = data[tostring(target)]['settings']['chal']
  if group_chal_lock == '🔓' then
    return 'chal ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['chal'] = '🔓'
    save_data(_config.moderation.data, data)
    return 'chal нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_reply(msg, data, target)
  ...
  if group_reply_lock == '🔒' then
    return '🔒reply ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['reply'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒reply нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_reply(msg, data, target)
  ...
  local group_reply_lock = data[tostring(target)]['settings']['reply']
  if group_reply_lock == '🔓' then
    return '🔓reply ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['reply'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓reply нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_username(msg, data, target)
  ...
  if group_username_lock == '🔒' then
    return '🔒υѕerɴαмe ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['username'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒υѕerɴαмe нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_username(msg, data, target)
  ...
  local group_username_lock = data[tostring(target)]['settings']['username']
  if group_username_lock == '🔓' then
    return '🔓υѕerɴαмe ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['username'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓υѕerɴαмe нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_media(msg, data, target)
  ...
  if group_media_lock == '🔒' then
    return '🔒мedια ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['media'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒мedια нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_media(msg, data, target)
  ...
  local group_media_lock = data[tostring(target)]['settings']['media']
  if group_media_lock == '🔓' then
    return '🔓мedια ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['media'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓мedια нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_fosh(msg, data, target)
  ...
  if group_fosh_lock == '🔒' then
    return '🔒ғoѕн ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['fosh'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒ғoѕн нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_fosh(msg, data, target)
  ...
  local group_fosh_lock = data[tostring(target)]['settings']['fosh']
  if group_fosh_lock == '🔓' then
    return '🔓ғoѕн ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['fosh'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓ғoѕн нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_join(msg, data, target)
  ...
  if group_join_lock == '🔒' then
    return '🔒 joιɴ ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['join'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒 joιɴ нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_join(msg, data, target)
  ...
  local group_join_lock = data[tostring(target)]['settings']['join']
  if group_join_lock == '🔓' then
    return '🔓 joιɴ ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['join'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓 joιɴ нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == '🔒' then
    return '🔒ғwd ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['fwd'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒ғwd нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_fwd(msg, data, target)
  ...
  local group_fwd_lock = data[tostring(target)]['settings']['fwd']
  if group_fwd_lock == '🔓' then
    return '🔓ғwd ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['fwd'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓ғwd нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_english(msg, data, target)
  ...
  if group_english_lock == '🔒' then
    return '🔒eɴɢlιѕн ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['english'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒eɴɢlιѕн нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_english(msg, data, target)
  ...
  local group_english_lock = data[tostring(target)]['settings']['english']
  if group_english_lock == '🔓' then
    return '🔓eɴɢlιѕн ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['english'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓eɴɢlιѕн нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == '🔒' then
    return '🔒eмojι ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['emoji'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒eмojι нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  local group_emoji_lock = data[tostring(target)]['settings']['emoji']
  if group_emoji_lock == '🔓' then
    return '🔓eмojι ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['emoji'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓eмojι нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_tag(msg, data, target)
  ...
  if group_tag_lock == '🔒' then
    return '🔒тαɢ ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['tag'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒тαɢ нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  local group_tag_lock = data[tostring(target)]['settings']['tag']
  if group_tag_lock == '🔓' then
    return '🔓тαɢ ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['tag'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓тαɢ нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == '🔒' then
    return '🔒ѕυperɢroυp ѕpαм ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_spam'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒ѕυperɢroυp ѕpαм нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  local group_spam_lock = data[tostring(target)]['settings']['lock_spam']
  if group_spam_lock == '🔓' then
    return '🔓ѕυperɢroυp ѕpαм ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['lock_spam'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓ѕυperɢroυp ѕpαм нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == '🔒' then
    return '🔒ғlood ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['flood'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒ғlood нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  local group_flood_lock = data[tostring(target)]['settings']['flood']
  if group_flood_lock == '🔓' then
    return '🔓ғlood ιѕ ɴoт locĸed🔓'
  else
    data[tostring(target)]['settings']['flood'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓ғlood нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == '🔒' then
    return '🔒αrαвιc ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_arabic'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒αrαвιc нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  local group_arabic_lock = data[tostring(target)]['settings']['lock_arabic']
  if group_arabic_lock == '🔓' then
    return '🔓αrαвιc ιѕ αlreαdy υɴlocĸed🔓'
  else
    data[tostring(target)]['settings']['lock_arabic'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓αrαвιc нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_membermod(msg, data, target)
  ...
  if group_member_lock == '🔒' then
    return '🔒ѕυperɢroυp мeмвer αre αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_member'] = '🔒'
    save_data(_config.moderation.data, data)
  end
  return '🔒ѕυperɢroυp мeмвer нαѕ вeeɴ locĸed🔒'
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  local group_member_lock = data[tostring(target)]['settings']['lock_member']
  if group_member_lock == '🔓' then
    return '🔓ѕυperɢroυp мeмвer are not locked🔓'
  else
    data[tostring(target)]['settings']['lock_member'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓ѕυperɢroυp мeмвer нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == '🔒' then
    return '🔒rтl ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_rtl'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒rтl нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  local group_rtl_lock = data[tostring(target)]['settings']['lock_rtl']
  if group_rtl_lock == '🔓' then
    return '🔓rтl ιѕ αlreαdy υɴlocĸed🔓'
  else
    data[tostring(target)]['settings']['lock_rtl'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓RTL нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == '🔒' then
    return '🔒тɢѕervιce ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_tgservice'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒тɢѕervιce нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  local group_tgservice_lock = data[tostring(target)]['settings']['lock_tgservice']
  if group_tgservice_lock == '🔓' then
    return '🔓тɢѕervιce ιѕ ɴoт locĸed!🔓'
  else
    data[tostring(target)]['settings']['lock_tgservice'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓тɢѕervιce нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == '🔒' then
    return '🔒ѕтιcĸer poѕтιɴɢ ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_sticker'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒ѕтιcĸer poѕтιɴɢ нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  local group_sticker_lock = data[tostring(target)]['settings']['lock_sticker']
  if group_sticker_lock == '🔓' then
    return '🔓ѕтιcĸer poѕтιɴɢ ιѕ αlreαdy unlocked🔓'
  else
    data[tostring(target)]['settings']['lock_sticker'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓ѕтιcĸer poѕтιɴɢ нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function lock_group_bots(msg, data, target)
  ...
  if group_bots_lock == '🔒' then
    return '🔒вoтѕ proтecтιoɴ ιѕ αlreαdy eɴαвled🔒'
  else
    data[tostring(target)]['settings']['lock_bots'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒вoтѕ proтecтιoɴ нαѕ вeeɴ eɴαвled🔒'
  end
end
...
local function unlock_group_bots(msg, data, target)
  ...
  local group_bots_lock = data[tostring(target)]['settings']['lock_bots']
  if group_bots_lock == '🔓' then
    return '🔓вoтѕ proтecтιoɴ ιѕ αlreαdy dιѕαвled🔓'
  else
    data[tostring(target)]['settings']['lock_bots'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓вoтѕ proтecтιoɴ нαѕ вeeɴ dιѕαвled🔓'
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == '🔒' then
    return '🔒coɴтαcтѕ poѕтιɴɢ ιѕ αlreαdy locĸed🔒'
  else
    data[tostring(target)]['settings']['lock_contacts'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒coɴтαcтѕ poѕтιɴɢ нαѕ вeeɴ locĸed🔒'
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == '🔓' then
    return '🔓coɴтαcтѕ poѕтιɴɢ ιѕ αlreαdy unlocked🔓'
  else
    data[tostring(target)]['settings']['lock_contacts'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓coɴтαcтѕ poѕтιɴɢ нαѕ вeeɴ υɴlocĸed🔓'
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == '🔒' then
    return '🔒ѕeттιɴɢѕ αre αlreαdy ѕтrιcтly eɴғorced🔒'
  else
    data[tostring(target)]['settings']['strict'] = '🔒'
    save_data(_config.moderation.data, data)
    return '🔒ѕeттιɴɢѕ wιll вe ѕтrιcтly eɴғorced🔒'
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  local group_strict_lock = data[tostring(target)]['settings']['strict']
  if group_strict_lock == '🔓' then
    return '🔓ѕeттιɴɢѕ αre ɴoт ѕтrιcтly eɴғorced🔓'
  else
    data[tostring(target)]['settings']['strict'] = '🔓'
    save_data(_config.moderation.data, data)
    return '🔓ѕeттιɴɢѕ wιll ɴoт вe ѕтrιcтlyeɴғorced🔓'
  end
end
...
local function get_rules(msg, data)
  ...
  if not data[tostring(msg.to.id)][data_cat] then
    return '💢ɴo rυleѕ αvαιlαвle.💢'
  end
  local rules = data[tostring(msg.to.id)][data_cat]
  local group_name = data[tostring(msg.to.id)]['settings']['set_name']
  local rules = group_name..' rυleѕ:\n\n'..rules:gsub("/n", " ")
  return rules
end
...
local function set_public_membermod(msg, data, target)
  ...
  if group_public_lock == 'yes' then
    return 'Group ιѕ αlreαdy public'
  else
...
function show_supergroup_settingsmod(msg, target)
 ...
 local bots_protection = "🔒"
	...
	if data[tostring(target)]['settings'] then
		if not data[tostring(target)]['settings']['num'] then
			data[tostring(target)]['settings']['num'] = '🔓'
		end
	end
	if data[tostring(target)]['settings'] then
		if not data[tostring(target)]['settings']['chal'] then
			data[tostring(target)]['settings']['chal'] = '🔓'
		end
	end
	if data[tostring(target)]['settings'] then
		if not data[tostring(target)]['settings']['web'] then
			data[tostring(target)]['settings']['web'] = '🔓'
		end
	end
	if data[tostring(target)]['settings'] then
...
local function promote_admin(receiver, member_username, user_id)
  ...
  if data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_username..' ιѕ αlreαdy α мoderαтor.')
  end
...
local function demote_admin(receiver, member_username, user_id)
  ...
  if not data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_tag_username..'  ιѕ ɴo α мoderαтor.')
  end
...
local function promote2(receiver, member_username, user_id)
  ...
  if data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_username..' ιѕ αlreαdy α мoderαтor.✔️')
  end
  data[group]['moderators'][tostring(user_id)] = member_tag_username
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username..' нαѕ вeeɴ proмoтed.✔️')
end
...
local function demote2(receiver, member_username, user_id)
  ...
  if not data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_tag_username..' ιѕ ɴo α мoderαтor.✖️')
  end
  data[group]['moderators'][tostring(user_id)] = nil
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username..' нαѕ вeeɴ deмoтed.✖️')
end
...
local function modlist(msg)
  ...
  if next(data[tostring(msg.to.id)]['moderators']) == nil then
    return '❌❌ɴo мoderαтorѕ  ιɴ тнιѕ ɢroυp.❌❌'
  end
  local i = 1
  local message = '\n👤lιѕт oғ мoderαтorѕ ғor [' .. string.gsub(msg.to.print_name, '_', ' ') .. ']👤:\n'
	...
	local data = load_data(_config.moderation.data)
		if matches[1] == 'add' and not matches[2] then
			...
			if is_super_group(msg) then
				return reply_msg(msg.id, '💠SuperGroup ιѕ αlreαdy added.💠', ok_cb, false)
			end
		...
		unlock_group_operator(msg, data, target),
      	...
      	return lock_group_etehad(msg, data, target), etehad
			...
			if matches[2] == 'number' then
				...
				return lock_group_num(msg, data, target)
			end
			if matches[2] == 'chalesh' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] locked chalesh")
				return lock_group_chal(msg, data, target)
			end
			if matches[2] == 'web' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] locked web")
				return lock_group_web(msg, data, target)
			end
		end
		...
		unlock_group_operator(msg, data, target),
      	...
      	return unlock_group_etehad(msg, data, target), detehad
			...
			if matches[2] == 'number' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] locked number")
				return unlock_group_num(msg, data, target)
			end
			if matches[2] == 'chalesh' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] locked chalesh")
				return unlock_group_chal(msg, data, target)
			end
			if matches[2] == 'web' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] locked web")
				return unlock_group_web(msg, data, target)
			end
		end
		...
		if matches[1] == 'mute' and is_owner(msg) then
			...
			local msg_type = 'Audio'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return "SuperGroup mute "..msg_type.." ιѕ αlreαdy on🔇"
				end
			end
			...
			local msg_type = 'Text'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return "Mute "..msg_type.." ιѕ αlreαdy on🔇"
				end
			end
			if matches[2] == 'all' then
			local msg_type = 'All'
		...
		if matches[1] == 'unmute' and is_momod(msg) then
			...
			local msg_type = 'Audio'
				if is_muted(chat_id, msg_type..': yes') then
					...
					return "Mute "..msg_type.." ιѕ αlreαdy off🔊"
				end
			end
			if matches[2] == 'photo' then
			local msg_type = 'Photo'
			...
			local msg_type = 'Text'
				if is_muted(chat_id, msg_type..': yes') then
					...
					return "Mute text ιѕ αlreαdy off🔊"
				end
			end
			if matches[2] == 'all' then
			local msg_type = 'All'
				if is_muted(chat_id, msg_type..': yes') then
					...
					return "Mute "..msg_type.." ιѕ αlreαdy disabled🔊"
				end
			end
		end
